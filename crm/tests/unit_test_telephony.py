...
class EndpointGatingTests(unittest.TestCase):
	def test_all_session_only(self):
		for fn in (telephony.lines, telephony.set_my_mute, telephony.search_numbers, telephony.buy_number, telephony.dial, telephony.active_calls, telephony.join, telephony.set_mode, telephony.inbox,
